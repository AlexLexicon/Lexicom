...
internal static class AdvancedReadLine
{
    ...
    public static string? WithInterception(params AdvancedReadLineIntercept[] keysToInterrupt)
    {
        ...
        {
            var intercepter = keysToInterrupt.FirstOrDefault(i => i.InterceptKey == cki.Key);
            if (intercepter is not null)
            {
                ...
                if (result.Input is not null)
                {
                    ...
                    {
                        Default(ref index, character, builder);
                    }
                }
            }
            ...
            else
            {
                ...
                Default(ref index, cki.KeyChar, builder);
            }
    ...
    private static void Default(ref int index, char keyChar, StringBuilder builder)
    {
        int previousIndex = index;
        index++;
