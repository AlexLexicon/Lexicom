...
public static class MvvmServiceBuilderExtensions
{
    ...
    private static void DeferredAddMediatR(IMvvmServiceBuilder builder, MediatRServiceConfiguration mediatRServiceConfiguration)
    {
        ...
        notificationHandlersForViewModels.AddRange(ReRegisterMediatRHandlersForViewModels(builder.Services, typeof(INotificationHandler<>)));
        ReRegisterMediatRHandlersForViewModels(builder.Services, typeof(IRequestHandler<>));
        ReRegisterMediatRHandlersForViewModels(builder.Services, typeof(IRequestHandler<,>));

        foreach (ServiceDescriptor notificationHandlerDescription in notificationHandlersForViewModels)
        {
            List<ServiceDescriptor> handlerImplementations = builder.Services
            ...
            foreach (ServiceDescriptor handlerImplementation in handlerImplementations)
            {
                ...
                builder.Services.Remove(handlerImplementation);
    ...
    private static MethodInfo StaticSetupNotificationHandlersForViewModelsMethodInfo => _staticSetupNotificationHandlersForViewModelsMethodInfo ??= (typeof(MvvmServiceBuilderExtensions).GetMethod(nameof(SetupNotificationHandlersForViewModels), BindingFlags.Static | BindingFlags.NonPublic) ?? throw new UnreachableException($"The method '{nameof(SetupNotificationHandlersForViewModels)}' was not found."));
    ...
    private static MethodInfo StaticSetupRequestHandlersForViewModelsMethodInfo => _staticSetupRequestHandlersForViewModelsMethodInfo ??= (typeof(MvvmServiceBuilderExtensions).GetMethod(nameof(SetupRequestHandlersForViewModels), BindingFlags.Static | BindingFlags.NonPublic) ?? throw new UnreachableException($"The method '{nameof(SetupRequestHandlersForViewModels)}' was not found."));
